        ...
        <div class="visual1">
            ...
            <div class="hasildiagnosa">
                ...
                <div class="penjabaran">
                    <p style="text-indent: 45px;">Berdasarkan gejala yang di inputkan oleh pendiagnosa, yang dikirim pada tanggal <strong><?= $waktu[0] ?></strong> Jam <strong><?= $waktu[1] ?> </strong>. Didapatkan hasil bahwa tanaman manggis di diagnosa terserang Penyakit <strong><?= $tertinggi[0] ?></strong> dengan Tingkat Kepercayaan (Certainty) sebesar <strong><?= $tertinggi[1] * 100?>%</strong>. <i id="ketklik">Untuk detail penyakit dan penanganan lebih lanjut dapat dilihat dengan meng-klik tombol detail penyakit.</i></p>
                </div>
                <div class="detailpenyakit" id="detailpenyakit" style="display:none;">
